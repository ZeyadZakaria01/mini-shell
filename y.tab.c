...
static const YYINT yydefred[] = {                         0,
    0,   13,    7,    0,    0,    2,    4,    0,   23,   11,
    8,    3,    0,    0,    0,    0,    0,    0,    0,   20,
    0,   14,   15,   18,   22,   16,   17,   24,    0,   19,
   12,   10,    6,
};
#if defined(YYDESTRUCT_CALL) || defined(YYSTYPE_TOSTRING)
static const YYINT yystos[] = {                           0,
  256,  257,  260,  269,  270,  271,  272,  273,  276,  277,
  260,  271,  259,  261,  262,  264,  266,  267,  274,  280,
  278,  257,  257,  257,  276,  257,  257,  265,  275,  280,
  257,  279,  260,
};
#endif /* YYDESTRUCT_CALL || YYSTYPE_TOSTRING */
static const YYINT yydgoto[] = {                          4,
    5,    6,    7,    8,   19,   29,    9,   10,   21,   32,
   20,
};
static const YYINT yysindex[] = {                      -228,
 -256,    0,    0,    0, -228,    0,    0, -250,    0,    0,
    0,    0, -247, -244, -242, -234, -227, -226, -241,    0,
 -224,    0,    0,    0,    0,    0,    0,    0, -225,    0,
    0,    0,    0,
};
static const YYINT yyrindex[] = {                        19,
    0,    0,    0,    0,   34,    0,    0, -238,    0,    0,
...
static const YYINT yygindex[] = {                         0,
    0,   31,    0,    0,    0,    0,   22,    0,    0,    0,
   20,
};
#define YYTABLESIZE 39
static const YYINT yytable[] = {                          9,
    9,    9,    9,   11,    9,    9,    9,    9,   13,   22,
   14,   15,   23,   16,   24,   17,   18,   13,    5,   14,
   15,   21,    2,   28,   17,   18,   21,    1,    2,   26,
   27,    3,   31,    1,   33,   12,   25,   25,   30,
};
static const YYINT yycheck[] = {                        259,
  260,  261,  262,  260,  264,  265,  266,  267,  259,  257,
  261,  262,  257,  264,  257,  266,  267,  259,    0,  261,
  262,  260,  257,  265,  266,  267,  265,  256,  257,  257,
  257,  260,  257,    0,  260,    5,  260,   16,   19,
};
#if YYBTYACC
...
"NEWLINE","GGREAT","LESS","LLESS","PIPE","AMPERSAND","GREATAMPERCAND",
"GGREATAMPERCAND","$accept","goal","commands","command","simple_command",
"pipe_list","iomodifier_list","background_opt","command_and_args",
...
"iomodifier_opt : GGREAT WORD",
"iomodifier_opt : GREATAMPERCAND WORD",
"iomodifier_opt : GGREATAMPERCAND WORD",
