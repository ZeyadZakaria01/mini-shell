...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    GREATAMPERCAND = 267,          /* GREATAMPERCAND  */
    GGREATAMPERCAND = 268          /* GGREATAMPERCAND  */
  };
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_GGREAT = 7,                     /* GGREAT  */
  YYSYMBOL_LESS = 8,                       /* LESS  */
  YYSYMBOL_LLESS = 9,                      /* LLESS  */
  YYSYMBOL_PIPE = 10,                      /* PIPE  */
  YYSYMBOL_AMPERSAND = 11,                 /* AMPERSAND  */
  YYSYMBOL_GREATAMPERCAND = 12,            /* GREATAMPERCAND  */
  YYSYMBOL_GGREATAMPERCAND = 13,           /* GGREATAMPERCAND  */
  ...
  YYSYMBOL_pipe_list = 25,                 /* pipe_list  */
...
{
       0,    36,    36,    40,    41,    45,    46,    50,    54,    55,
      59,    66,    67,    71,    78,    87,    91,   101,   109,   118,
     125,   126,   127,   131,   132,   137,   141
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREAT", "NEWLINE", "GGREAT", "LESS", "LLESS", "PIPE", "AMPERSAND",
  "GREATAMPERCAND", "GGREATAMPERCAND", "$accept", "goal", "commands",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 7: /* simple_command: pipe_list iomodifier_list background_opt NEWLINE  */
#line 50 "shell.y"
                                                         {
...
#line 1232 "y.tab.c"
  ...
  case 16: /* iomodifier_opt: GGREAT WORD  */
#line 91 "shell.y"
                      {
...
#line 1247 "y.tab.c"
  ...
  case 17: /* iomodifier_opt: GREATAMPERCAND WORD  */
#line 101 "shell.y"
                          {
            if( Command::_currentCommand._outFile) {
...
#line 1260 "y.tab.c"
  ...
  case 18: /* iomodifier_opt: GGREATAMPERCAND WORD  */
#line 109 "shell.y"
                           {
            if( Command::_currentCommand._outFile) {
